...
function ResetPawn(victim) {
    ...
    switch (victim) {
        ...
        */
        case "redpawn1":
            pawnToMove.style.top = 250 + "px";
            pawnToMove.style.left = 550 + "px";
            break;
        case "redpawn2":
            pawnToMove.style.top = 203 + "px";
            pawnToMove.style.left = 503 + "px";
            break;
        case "redpawn3":
            pawnToMove.style.top = 156 + "px";
            pawnToMove.style.left = 550 + "px";
            break;
        case "redpawn4":
            pawnToMove.style.top = 203 + "px";
            pawnToMove.style.left = 598 + "px";
            break;

        case "bluepawn1":
            pawnToMove.style.top = 552 + "px";
            pawnToMove.style.left = 598 + "px";
            break;
        case "bluepawn2":
            pawnToMove.style.top = 552 + "px";
            ...
            break;
        case "bluepawn3":
            pawnToMove.style.top = 505 + "px";
            pawnToMove.style.left = 550 + "px";
            break;
        case "bluepawn4":
            pawnToMove.style.top = 599 + "px";
            pawnToMove.style.left = 550 + "px";
            break;

        case "greenpawn1":
            pawnToMove.style.top = 250 + "px";
            pawnToMove.style.left = 201 + "px";
            break;
        case "greenpawn2":
            pawnToMove.style.top = 203 + "px";
            pawnToMove.style.left = 248 + "px";
            break;
        case "greenpawn3":
            pawnToMove.style.top = 156 + "px";
            pawnToMove.style.left = 201 + "px";
...
function randomMove(Color, paw) {
    ...
    var storePosition = JSON.stringify({
        position: positions,
        onboard: onboard
    });
...
function pawn_position(storePosition) {
    ...
    var a = JSON.stringify({
        red_pawn_1: [red_pawn_1.top, red_pawn_1.left]
    });
    var pawn_data = JSON.stringify({
        red_pawn_1: [red_pawn_1.top, red_pawn_1.left],
        red_pawn_2: [red_pawn_2.top, red_pawn_2.left],
        red_pawn_3: [red_pawn_3.top, red_pawn_3.left],
        red_pawn_4: [red_pawn_4.top, red_pawn_4.left],
        blue_pawn_1: [blue_pawn_1.top, blue_pawn_1.left],
        blue_pawn_2: [blue_pawn_2.top, blue_pawn_2.left],
        blue_pawn_3: [blue_pawn_3.top, blue_pawn_3.left],
        blue_pawn_4: [blue_pawn_4.top, blue_pawn_4.left],
        yellow_pawn_1: [yellow_pawn_1.top, yellow_pawn_1.left],
        yellow_pawn_2: [yellow_pawn_2.top, yellow_pawn_2.left],
        yellow_pawn_3: [yellow_pawn_3.top, yellow_pawn_3.left],
        yellow_pawn_4: [yellow_pawn_4.top, yellow_pawn_4.left],
        green_pawn_1: [green_pawn_1.top, green_pawn_1.left],
        green_pawn_2: [green_pawn_2.top, green_pawn_2.left],
        green_pawn_3: [green_pawn_3.top, green_pawn_3.left],
        green_pawn_4: [green_pawn_4.top, green_pawn_4.left]
    });
